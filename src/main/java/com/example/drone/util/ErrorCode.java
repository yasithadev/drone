...
public class ErrorCode {
	public static final String REGISTERED_SERIAL_NUMBER_101 = "101:incorrect drone id";
	public static final String INCORRECT_DRONE_ID_102 = "102:incorrect drone id";
